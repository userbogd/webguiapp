...
static void PrintMACFromInterface(char *argres, int rw, esp_netif_t *netif)
{
    ...
    snprintf(argres, VAR_MAX_VALUE_LENGTH, "\"%02x-%02x-%02x-%02x-%02x-%02x\"", mac_addr[0], mac_addr[1], mac_addr[2],
...
const rest_var_t SystemVariables[] = {
    ...
    {0, "usbnet_mac_local", &funct_usbnet_mac_local, VAR_FUNCT, RW, 0, 0},
    {0, "usbnet_mac_remote", &funct_usbnet_mac_remote, VAR_FUNCT, RW, 0, 0},
    {0, "usbnet_visible", (bool *)(&VAR_FALSE), VAR_BOOL, R, 0, 1},
#else
    {0, "usbnet_visible", (bool *)(&VAR_FALSE), VAR_BOOL, R, 0, 1},
#endif
